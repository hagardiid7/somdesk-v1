...
function App() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Professional IT Solutions for Your Business</h1>
            <p className="text-xl text-blue-100 mb-8">Expert computer repair, printer services, and CCTV installation</p>
